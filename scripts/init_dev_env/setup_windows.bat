...
REM ModelArk - Modern Development Environment Setup (Windows)
...
echo ==========================================================
echo   Initializing ModelArk Development Environment...
echo ==========================================================
echo.
...
echo [3/4] Installing SDK (byteplus-python-sdk-v2) and dependencies...
%UV_CMD% pip install "byteplus-python-sdk-v2" "httpx" "pydantic" "sniffio" --python "..\..\.venv"
